...
/**
 * public class Planet with name and avgRadiusInKm as fields.
 */
public class Planet {
   ...
   */
  public Planet(String newName, int radius) {
    setName(newName);
  ...
  /**
   * sets the radius and it can not be changed later due to private acces
   * modifyer.
   *
  ...
  private void setAvgRadiusInKm(int radius) {
    ...
    if (radius < 2000 || radius > 200000) { // checks radius range.
